...
sub get_person_season :Private {
  ...
  $c->add_status_message( "info", $c->maketext("people.name.changed-notice", $person_season_name, $person_name ) ) if defined( $person_season_name ) and $person_name ne $person_season_name;
