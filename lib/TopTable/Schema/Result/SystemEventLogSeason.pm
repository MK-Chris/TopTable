use utf8;
package TopTable::Schema::Result::SystemEventLogSeason;
...
=head1 TABLE: C<system_event_log_season>

=cut

__PACKAGE__->table("system_event_log_season");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:NDl1fcHi+RpZW26lHtP/jQ
