use utf8;
package TopTable::Schema::Result::SystemEventLogClub;
...
=head1 TABLE: C<system_event_log_club>

=cut

__PACKAGE__->table("system_event_log_club");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:L+qgxYWvDsCLwWy0yEqhJA
