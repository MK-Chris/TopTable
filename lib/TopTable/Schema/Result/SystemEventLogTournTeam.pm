use utf8;
package TopTable::Schema::Result::SystemEventLogTournTeam;
...
=head1 TABLE: C<system_event_log_tourn_team>

=cut

__PACKAGE__->table("system_event_log_tourn_team");
...
Only used if there is no ID (i.e., if the object was deleted and is not available).
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:BxP0xS+xReQ8GHySQvqJzg

# Enable automatic date handling
__PACKAGE__->add_columns(
    "log_updated",
    { data_type => "datetime", timezone => "UTC", timezone => "UTC", set_on_create => 1, set_on_update => 1, datetime_undef_if_invalid => 1, is_nullable => 0, },
);
