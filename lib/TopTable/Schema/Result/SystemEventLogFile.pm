use utf8;
package TopTable::Schema::Result::SystemEventLogFile;
...
=head1 TABLE: C<system_event_log_file>

=cut

__PACKAGE__->table("system_event_log_file");
...
Related object: L<TopTable::Schema::Result::UploadedFile>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:44UIHsS6rqbcviaRtU45QA
