use utf8;
package TopTable::Schema::Result::TournamentGroupPerson;
...
=head1 TABLE: C<tournament_group_people>

=cut

__PACKAGE__->table("tournament_group_people");
...
__PACKAGE__->belongs_to(
  ...
  { id => "tournament_round_person" },
  { is_deferrable => 1, on_delete => "RESTRICT", on_update => "RESTRICT" },
);


# Created by DBIx::Class::Schema::Loader v0.07051 @ 2024-09-29 23:47:56
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:hPaNtMgbzUA1vnWNWRByIg
...
sub object_id {
  my $self = shift;
  return $self->tournament_round_person->tournament_person->person_season->person->id;
}
...
sub object_name {
  my $self = shift;
  return $self->tournament_round_person->tournament_person->person_season->display_name;
}
