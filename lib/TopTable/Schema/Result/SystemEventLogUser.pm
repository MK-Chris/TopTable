use utf8;
package TopTable::Schema::Result::SystemEventLogUser;
...
=head1 TABLE: C<system_event_log_user>

=cut

__PACKAGE__->table("system_event_log_user");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:C+mUaHtogHdSFWRUG+6rag
