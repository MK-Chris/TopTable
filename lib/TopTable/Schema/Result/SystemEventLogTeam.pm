use utf8;
package TopTable::Schema::Result::SystemEventLogTeam;
...
=head1 TABLE: C<system_event_log_team>

=cut

__PACKAGE__->table("system_event_log_team");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:9lRiugJ6EKcslSZrPnQH3A
