use utf8;
package TopTable::Schema::Result::SystemEventLogTemplateMatchTeamGame;
...
=head1 TABLE: C<system_event_log_template_match_team_game>

=cut

__PACKAGE__->table("system_event_log_template_match_team_game");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:6Asmhf8O0/R6aDGB5hrBCg
