use utf8;
package TopTable::Schema::Result::SystemEventLogImage;
...
=head1 TABLE: C<system_event_log_image>

=cut

__PACKAGE__->table("system_event_log_image");
...
Related object: L<TopTable::Schema::Result::UploadedImage>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:2u3jkuL1mw13pCZcYWBT5A
