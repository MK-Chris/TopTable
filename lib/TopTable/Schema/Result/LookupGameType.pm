use utf8;
package TopTable::Schema::Result::LookupGameType;
...
=head1 TABLE: C<lookup_game_types>

=cut

__PACKAGE__->table("lookup_game_types");
...
__PACKAGE__->has_many(
  ...
  { "foreign.game_type" => "self.id" },
  { cascade_copy => 0, cascade_delete => 0 },
);


# Created by DBIx::Class::Schema::Loader v0.07043 @ 2015-09-14 23:06:42
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:mOTC05xS081+HtpqnrSY0A
