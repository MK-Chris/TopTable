use utf8;
package TopTable::Schema::Result::SystemEventLogMeetingType;
...
=head1 TABLE: C<system_event_log_meeting_type>

=cut

__PACKAGE__->table("system_event_log_meeting_type");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:DR9Gg89tkcgIkrYCW/0vRw
