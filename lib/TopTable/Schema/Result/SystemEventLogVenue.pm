use utf8;
package TopTable::Schema::Result::SystemEventLogVenue;
...
=head1 TABLE: C<system_event_log_venue>

=cut

__PACKAGE__->table("system_event_log_venue");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:dUTEt8hgcVsx2Ze2n5jdNg
