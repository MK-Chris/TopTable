use utf8;
package TopTable::Schema::Result::SystemEventLogEvent;
...
=head1 TABLE: C<system_event_log_event>

=cut

__PACKAGE__->table("system_event_log_event");
...
# Created by DBIx::Class::Schema::Loader v0.07043 @ 2016-01-08 22:47:56
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:q0QuVtEWA71HiIqAVcWTyg
