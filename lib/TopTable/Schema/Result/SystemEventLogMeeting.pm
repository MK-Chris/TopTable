use utf8;
package TopTable::Schema::Result::SystemEventLogMeeting;
...
=head1 TABLE: C<system_event_log_meeting>

=cut

__PACKAGE__->table("system_event_log_meeting");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Dh5XLZtPB3bSudofwEY4qw
