use utf8;
package TopTable::Schema::Result::SystemEventLogPerson;
...
=head1 TABLE: C<system_event_log_person>

=cut

__PACKAGE__->table("system_event_log_person");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:FsodEwgO43niVWkqlgH2uw
