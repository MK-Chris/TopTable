use utf8;
package TopTable::Schema::Result::SystemEventLogTemplateMatchTeam;
...
=head1 TABLE: C<system_event_log_template_match_team>

=cut

__PACKAGE__->table("system_event_log_template_match_team");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:zrGntMXPqLKT1JTkKyEFNw
