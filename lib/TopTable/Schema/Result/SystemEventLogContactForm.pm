use utf8;
package TopTable::Schema::Result::SystemEventLogContactForm;
...
=head1 TABLE: C<system_event_log_contact_form>

=cut

__PACKAGE__->table("system_event_log_contact_form");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:qdAwyBN8qa2LOt9Yq0TXMg
