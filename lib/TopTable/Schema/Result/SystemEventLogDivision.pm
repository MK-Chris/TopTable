use utf8;
package TopTable::Schema::Result::SystemEventLogDivision;
...
=head1 TABLE: C<system_event_log_division>

=cut

__PACKAGE__->table("system_event_log_division");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:xv26TLfyWJSGheoqHpOGyQ
