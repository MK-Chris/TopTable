use utf8;
package TopTable::Schema::Result::SystemEventLogContactReason;
...
=head1 TABLE: C<system_event_log_contact_reason>

=cut

__PACKAGE__->table("system_event_log_contact_reason");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:8QmcKPqYvEtj2KSvtQ8O8w
