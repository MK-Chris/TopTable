use utf8;
package TopTable::Schema::Result::TournamentRoundGroupIndividualMembership;
...
=head1 TABLE: C<tournament_round_group_individual_membership>

=cut

__PACKAGE__->table("tournament_round_group_individual_membership");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:24GRhj/bzmbertAGuwevmg
