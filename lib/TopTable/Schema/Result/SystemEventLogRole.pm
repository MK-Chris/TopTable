use utf8;
package TopTable::Schema::Result::SystemEventLogRole;
...
=head1 TABLE: C<system_event_log_role>

=cut

__PACKAGE__->table("system_event_log_role");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:C+EjKrQDVb+JVpZ8K28AaA
