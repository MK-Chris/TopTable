use utf8;
package TopTable::Schema::Result::SystemEventLogTemplateLeagueTableRanking;
...
=head1 TABLE: C<system_event_log_template_league_table_ranking>

=cut

__PACKAGE__->table("system_event_log_template_league_table_ranking");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:gIX2kZoa6rnN7RH2U/BwFQ
