use utf8;
package TopTable::Schema::Result::PersonTournament;
...
=head1 TABLE: C<person_tournaments>

=cut

__PACKAGE__->table("person_tournaments");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:keUes30wPutmEBRk1uA/yQ
