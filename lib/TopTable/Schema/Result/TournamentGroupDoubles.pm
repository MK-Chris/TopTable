use utf8;
package TopTable::Schema::Result::TournamentGroupDoubles;
...
=head1 TABLE: C<tournament_group_doubles>

=cut

__PACKAGE__->table("tournament_group_doubles");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:J+PRmwpJASoZjjge4kofOw
...
sub object_id {
  my $self = shift;
  return $self->tournament_round_pair->tournament_pair->id;
}
...
sub object_name {
  ...
  my $person1_name = $self->tournament_round_pair->tournament_pair->person_season_person1_season_person1_team->display_name;
  my $person2_name = $self->tournament_round_pair->tournament_pair->person_season_person2_season_person2_team->display_name;
